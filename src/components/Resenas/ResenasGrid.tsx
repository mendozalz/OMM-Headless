...
const ResenasGrid: React.FC<ResenasGridProps> = ({ resenas }) => {
  ...
  return (
    <div className="container-resenas-grid mx-auto px-4 py-8 lg:max-w-[85vw] w-full flex justify-center">
          ...
          return (
            ...
            >
              <div className="p-6 flex flex-col h-full">
                <div className="mb-4">
                  <h3 className="text-xl font-bold text-verde-oscuro text-center mb-1">{resena.autor}</h3>
                  {resena.cargo && (
                    <p className="text-sm text-gray-600 text-center mb-4">{resena.cargo}</p>
                  )}
                </div>
                
                <div className="text-gray-700 mb-4 flex-grow overflow-hidden">
                  <p className="italic text-sm leading-relaxed">{truncateText(displayText, 40)}</p>
                </div>
